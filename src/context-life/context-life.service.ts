...
import { ContextLife, ContextLifeDocument } from './schemas/context-life.schema';

@Injectable()
export class ContextLifeService extends CatalogBaseService {
  protected readonly entityName = 'ContextLife';
  protected readonly dreamIdPath = 'analysis.entities.contextLife.contextLifeId';

  constructor(
    @InjectModel(ContextLife.name) protected readonly model: Model<ContextLifeDocument>,
  ...
  async update(id: string, dto: UpdateContextLifeDto): Promise<ContextLifeDocument> {
